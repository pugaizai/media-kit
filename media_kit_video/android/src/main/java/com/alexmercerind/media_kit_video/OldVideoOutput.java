...
public class OldVideoOutput implements TextureRegistry.SurfaceProducer.Callback {
    private static final String TAG = "OldVideoOutput";
    ...
    static {
        try {
            ...
            throw new RuntimeException("Failed to initialize com.alexmercerind.media_kit_video.OldVideoOutput.");
        }
    }
    ...
    OldVideoOutput(TextureRegistry textureRegistryReference, TextureUpdateCallback textureUpdateCallback) {
